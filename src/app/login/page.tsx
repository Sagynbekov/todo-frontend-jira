  ...
  return (
    <div className="flex items-center justify-center h-screen bg-gray-900">
      <form onSubmit={handleLogin} className="flex flex-col gap-4 p-6 bg-white rounded-lg shadow-xl w-80">
        <h2 className="text-2xl font-bold text-center text-gray-900 mb-2">To-do</h2>
        <input
          type="email"
          placeholder="Enter your Gmail"
          className="border border-gray-300 rounded px-3 py-2 focus:outline-none focus:border-gray-500 text-gray-900 placeholder-gray-500"
          value={email}
